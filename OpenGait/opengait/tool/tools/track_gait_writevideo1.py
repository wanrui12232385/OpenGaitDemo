...
# 运行指令：
# python3 OpenGait/opengait/tool/tools/track_gait_writevideo1.py video -f ByteTrack/exps/example/mot/yolox_x_mix_det.py -c ByteTrack/pretrained/bytetrack_x_mot17.pth.tar --fp16 --fuse --save_result  --phase test --compare
